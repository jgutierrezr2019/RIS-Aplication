...
beta = 10*log10(Aeff/(4*pi*d_RIStoUser^2)); % Pathloss desde RIS
gamma = 20*log10(N); % Ganancia RIS
gamma_2 = 20*log10(N) + 20*log10(Aeff*(4*pi)/(lambda)^2);
gamma_3 = 20*log10((4*pi/(lambda^2))*(0.4*0.4)); % Ganancia de las diapositivas
